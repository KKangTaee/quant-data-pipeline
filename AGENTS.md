...
- For user-facing post-selection work, use `Backtest > Post-Selection Guide` to read selected final review records and confirm final investment readiness plus rebalancing / reduce / stop / re-review guidance. Do not create a new post-selection registry in this phase: Final Review remains the durable final judgment, and Post-Selection Guide is a read / preview surface. Do not route this work back into Portfolio Proposal, and do not treat it as live approval or order execution.
