...
def append_backtest_run_history(
    *,
    ...
    record = {
        ...
        "position_sizing": meta.get("position_sizing"),
        ...
        "macro_filter_enabled": meta.get("macro_filter_enabled"),
        "macro_filter_mode": meta.get("macro_filter_mode"),
        "risk_on_min": meta.get("risk_on_min"),
        "rate_pressure_max": meta.get("rate_pressure_max"),
        "dollar_pressure_max": meta.get("dollar_pressure_max"),
        "safe_haven_max": meta.get("safe_haven_max"),
        "rate_pressure_penalty_weight": meta.get("rate_pressure_penalty_weight"),
        "dollar_pressure_penalty_weight": meta.get("dollar_pressure_penalty_weight"),
        "safe_haven_penalty_weight": meta.get("safe_haven_penalty_weight"),
        "min_avg_dollar_volume_20d": meta.get("min_avg_dollar_volume_20d"),
        "min_avg_volume_20d": meta.get("min_avg_volume_20d"),
        "random_iterations": meta.get("random_iterations"),
        ...
        "swing_artifact": meta.get("swing_artifact"),
        "top": meta.get("top"),
        "cash_ticker": meta.get("cash_ticker"),
        ...
        "real_money_hardening": meta.get("real_money_hardening"),
        "cost_model_contract_version": meta.get("cost_model_contract_version"),
        "cost_model_source": meta.get("cost_model_source"),
        "cost_model_formula": meta.get("cost_model_formula"),
        "cost_application_status": meta.get("cost_application_status"),
        "cost_application_target": meta.get("cost_application_target"),
        "cost_turnover_source": meta.get("cost_turnover_source"),
        "net_cost_curve_contract_version": meta.get("net_cost_curve_contract_version"),
        "net_cost_curve_status": meta.get("net_cost_curve_status"),
        "net_cost_curve_application_target": meta.get("net_cost_curve_application_target"),
        "total_balance_is_net_of_cost": meta.get("total_balance_is_net_of_cost"),
        "net_cost_curve_rows": meta.get("net_cost_curve_rows"),
        "transaction_cost_bps": meta.get("transaction_cost_bps"),
        "turnover_model_contract_version": meta.get("turnover_model_contract_version"),
        "turnover_estimation_status": meta.get("turnover_estimation_status"),
        "turnover_source": meta.get("turnover_source"),
        "turnover_input_missing_columns": meta.get("turnover_input_missing_columns"),
        "turnover_observation_count": meta.get("turnover_observation_count"),
        "turnover_rebalance_rows": meta.get("turnover_rebalance_rows"),
        "turnover_nonzero_count": meta.get("turnover_nonzero_count"),
        "avg_turnover": meta.get("avg_turnover"),
        "max_turnover": meta.get("max_turnover"),
        "avg_rebalance_turnover": meta.get("avg_rebalance_turnover"),
        "estimated_cost_total": meta.get("estimated_cost_total"),
        "estimated_cost_positive_rows": meta.get("estimated_cost_positive_rows"),
        "gross_start_balance": meta.get("gross_start_balance"),
        "gross_end_balance": meta.get("gross_end_balance"),
        "net_end_balance": meta.get("net_end_balance"),
        "gross_net_end_balance_delta": meta.get("gross_net_end_balance_delta"),
        "net_cagr_spread": meta.get("net_cagr_spread"),
        ...
        "guardrail_reference_ticker": meta.get("guardrail_reference_ticker"),
        ...
        "universe_contract": meta.get("universe_contract"),
        "dynamic_target_size": meta.get("dynamic_target_size"),
        "research_source": meta.get("research_source"),
        "requested_tickers": meta.get("requested_tickers"),
        "excluded_tickers": meta.get("excluded_tickers"),
        "malformed_price_rows": meta.get("malformed_price_rows"),
        "price_freshness": meta.get("price_freshness"),
