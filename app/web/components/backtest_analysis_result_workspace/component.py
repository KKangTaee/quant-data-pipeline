...
def is_backtest_analysis_result_workspace_available() -> bool:
    return _component is not None


def render_backtest_analysis_result_workspace_component(
    *,
    workspace: dict[str, Any],
    key: str,
    on_change: Callable[[], None] | None = None,
) -> dict[str, Any] | None:
    """Render the Python-owned result read model and return presentation intent."""
