...
import EventsHero, { buildEventsHeroCounts } from "./EventsHero";
import "./style.css";
  ...
  return (
    <section className="events-workbench">
      <EventsHero
        ...
        counts={buildEventsHeroCounts(brief.counts, calendarDays)}
        nextEvent={brief.next_event
          ...
          : null}
        primaryAction={{
          disabled: pendingActionId === (primaryAction?.id || "refresh_official"),
          label: pendingActionId === (primaryAction?.id || "refresh_official")
            ? "갱신 중"
            : (primaryAction?.label || "일정 갱신"),
