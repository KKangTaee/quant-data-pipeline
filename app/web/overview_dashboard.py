...
def render_overview_dashboard(
    *,
    ...
    st.caption("시장 스캔, macro / sentiment context, sector 흐름, events, data health를 한 화면에서 읽는 퀀트 워크벤치 대시보드입니다.")
    render_market_session_banner(_market_session_banner_model())

    market_tab, futures_tab, sentiment_tab, group_tab, events_tab, ops_tab = st.tabs(
        ["Market Movers", "Futures Monitor", "Sentiment", "Sector / Industry", "Events", "Data Health"]
    )
    with market_tab:
