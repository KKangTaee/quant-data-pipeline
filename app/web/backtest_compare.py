...
from app.web.backtest_compare_saved_replay import (
    ...
    is_saved_mix_replay_context as _is_saved_mix_replay_context,
...
def _saved_replay_render_context() -> SavedReplayRenderContext:
    return SavedReplayRenderContext(
        run_compare_strategy=_run_compare_strategy,
        resolve_dynamic_inputs=_resolve_saved_portfolio_dynamic_inputs,
        build_compare_data_trust_assessment=_build_compare_data_trust_assessment,
        render_weighted_portfolio_result=_render_weighted_portfolio_result,
        build_compare_strategy_overview_rows=_build_compare_strategy_overview_rows,
        compare_source_kind_label=_compare_source_kind_label,
        compare_mode_strategy=COMPARE_MODE_STRATEGY,
    )
...
def render_compare_portfolio_workspace() -> None:
    ...
    if st.session_state.backtest_compare_workspace_mode == COMPARE_MODE_STRATEGY:
        ...
        render_saved_portfolio_workspace(_saved_replay_render_context())
