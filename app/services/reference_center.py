...
REFERENCE_CENTER_ITEMS: list[dict[str, Any]] = [
    _item(
        ...
        meaning="Market Research의 시장 환경·종목 리서치·상세 리서치 관점을 함께 보며 현재 시장의 방향과 자료 한계를 구분하는 시작 흐름입니다.",
        impact="한 지표만으로 결론 내리지 않고 가격, 거시, 심리, 이벤트가 같은 이야기를 하는지 확인할 수 있습니다.",
        next_action="Market Research에서 Market Context를 먼저 읽고 필요한 보조 관점으로 이동합니다.",
        related_item_ids=[
