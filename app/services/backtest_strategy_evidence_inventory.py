...
_BASE_ROW_BY_KEY: dict[str, dict[str, Any]] = {
    ...
    "quality_snapshot_strict_quarterly_prototype": {
        "family": "Factor equity",
        "intended_role": "Quarterly quality factor candidate",
        "maturity_group": "Evidence mature",
        "maturity_label": "Formal strict quarterly",
        "product_lane": "Backtest Analysis candidate source",
        "runtime_support": "Supported",
        "compare_support": "Supported",
        "replay_support": "Supported with strict factor replay contract",
        "validation_readiness": "Practical Validation-ready after post-run Factor Readiness clears price and statement coverage",
        "monitoring_readiness": "Requires Final Review selected-route gate before monitoring",
        "current_anchor": "Post-run Factor Readiness plus quarterly runtime contract validation",
        "main_weakness": "Quarterly filing lag and PIT statement coverage remain more sensitive than annual",
        "evidence_anchor": "reports/backtests/validation/runtime/STRICT_QUARTERLY_PRODUCTIONIZATION_V1.md",
        "next_action": "Use Practical Validation after post-run readiness confirms no unresolved data gaps",
        "governance_status": "Standard workflow",
        "governance_note": "Formal candidate path, but quarterly cadence must clear post-run data readiness before promotion.",
        "candidate_group": "Quarterly formal candidate group",
        "tags": ["factor", "quarterly", "formal"],
    },
    "value_snapshot_strict_quarterly_prototype": {
        "family": "Factor equity",
        "intended_role": "Quarterly value factor candidate",
        "maturity_group": "Evidence mature",
        "maturity_label": "Formal strict quarterly",
        "product_lane": "Backtest Analysis candidate source",
        "runtime_support": "Supported",
    ...
    "quality_value_snapshot_strict_quarterly_prototype": {
        "family": "Factor equity",
        "intended_role": "Quarterly blended factor candidate",
        "maturity_group": "Evidence mature",
        "maturity_label": "Formal strict quarterly",
        "product_lane": "Backtest Analysis candidate source",
        "runtime_support": "Supported",
...
def build_strategy_evidence_inventory_summary() -> dict[str, Any]:
    ...
    return {
        ...
        "quarterly_formal_count": len(STRICT_QUARTERLY_FORMAL_KEYS),
        ...
        "next_scope_options": [
            ...
            "Quarterly formal candidate follow-up",
        ],
    }
