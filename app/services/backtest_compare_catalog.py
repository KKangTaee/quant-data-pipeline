...
from app.runtime.backtest.runner_catalog import get_runner_definition_for_display_name
    ...
    if strategy_name == "Risk-On Momentum 5D":
        return {
            ...
            "extra": {
                ...
                "dollar_pressure_penalty_weight": 10.0,
                "safe_haven_penalty_weight": 10.0,
