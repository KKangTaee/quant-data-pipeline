...
| 7단계 | `Portfolio Proposal` | 후보를 목적, 역할, 비중, capital scope가 있는 포트폴리오 초안으로 바꿈 | `Live Readiness 진입 평가` Route가 `LIVE_READINESS_CANDIDATE_READY`면 향후 Live Readiness 단계가 읽을 수 있는 형태 |
