...
| 구분 | 대표 문서 |
|---|---|
| Registry / artifact 운영 | `CURRENT_CANDIDATE_REGISTRY_GUIDE.md`, `CANDIDATE_REVIEW_NOTES_GUIDE.md`, `PRE_LIVE_CANDIDATE_REGISTRY_GUIDE.md`, `RUNTIME_ARTIFACT_HYGIENE.md` |
