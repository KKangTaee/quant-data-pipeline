...
| 구분 | 대표 문서 |
|---|---|
| Registry / artifact 운영 | `CURRENT_CANDIDATE_REGISTRY_GUIDE.md`, `CANDIDATE_REVIEW_NOTES_GUIDE.md`, `PRE_LIVE_CANDIDATE_REGISTRY_GUIDE.md`, `PORTFOLIO_PROPOSAL_REGISTRY_GUIDE.md`, `PAPER_PORTFOLIO_TRACKING_LEDGER_GUIDE.md`, `FINAL_PORTFOLIO_SELECTION_DECISIONS_GUIDE.md`, `RUNTIME_ARTIFACT_HYGIENE.md` |
| 작업 로그 정책 | `FINANCE_WORK_PROGRESS_POLICY.md` |
| 실습 / walkthrough | `BACKTEST_1_TO_11_WALKTHROUGH_SESSION.md` |
| 후보 선정 이후 운영 방향 | `FINAL_SELECTED_PORTFOLIO_OPERATIONS_DASHBOARD_GAP_20260504.md` |
...
- 운영성 문서는 이 폴더로 모은다.
- 코드 수정 흐름은 `../docs/architecture/`를 우선한다.
