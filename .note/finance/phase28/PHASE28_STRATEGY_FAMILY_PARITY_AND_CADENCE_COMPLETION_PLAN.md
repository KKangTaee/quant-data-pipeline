...
2. history / load / replay parity 확인
   ...
   - 현재 상태: `History Replay / Load Parity Snapshot`으로 history record의 저장 상태를 먼저 볼 수 있게 했다.
...
- Phase 28 다음 작업을 saved portfolio replay parity 또는 Data Trust Summary 확장 쪽으로 이어갈지 확인
