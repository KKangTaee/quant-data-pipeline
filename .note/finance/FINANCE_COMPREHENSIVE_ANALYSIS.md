...
- 최초 기준 시점: 2026-03-11
- 최근 동기화 기준: 2026-04-29 / Candidate Review render/helper module split
...
| Web Runtime / UI | Streamlit에서 single / compare / candidate review / history / saved replay / Pre-Live Review / Portfolio Proposal을 실행한다 | `app/web/runtime/*`, `app/web/pages/backtest.py`, `app/web/pages/backtest_candidate_review*.py` |
...
| Backtest UI | `app/web/pages/backtest.py`, `app/web/pages/backtest_candidate_review.py`, `app/web/pages/backtest_candidate_review_helpers.py` | Single / Compare / History / Saved Portfolio / Pre-Live Review / Portfolio Proposal 화면과 분리된 Candidate Review / Candidate Packaging 화면 및 helper |
...
| Web UI | `app/web/pages/backtest.py`, `app/web/pages/backtest_candidate_review.py`, `app/web/pages/backtest_candidate_review_helpers.py` | Single / Compare / History / Saved Portfolio / Pre-Live Review / Portfolio Proposal 화면과 Candidate Review / Candidate Packaging 화면 / helper |
