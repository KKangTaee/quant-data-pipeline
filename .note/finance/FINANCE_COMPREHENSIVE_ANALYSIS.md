...
- 최초 기준 시점: 2026-03-11
- 최근 동기화 기준: 2026-04-30 / Backtest Run History Operations split
...
| Web Runtime / UI | Streamlit에서 Overview dashboard, single / compare / candidate review / Pre-Live 운영 기록 / Operations history / saved replay / Portfolio Proposal을 실행한다 | `app/web/runtime/*`, `app/web/overview_dashboard*.py`, `app/web/pages/backtest.py`, `app/web/backtest_history.py`, `app/web/backtest_candidate_review*.py`, `app/web/backtest_portfolio_proposal*.py` |
...
| Backtest UI | `app/web/pages/backtest.py`, `app/web/backtest_history.py`, `app/web/backtest_ui_components.py`, `app/web/backtest_candidate_review.py`, `app/web/backtest_candidate_review_helpers.py`, `app/web/backtest_portfolio_proposal.py`, `app/web/backtest_portfolio_proposal_helpers.py` | Single / Compare / Candidate Review / Pre-Live 운영 기록 / Portfolio Proposal 주 흐름, Operations Backtest Run History / Saved Portfolio 보조 재현 화면, 공용 status/route UI component |
...
| Web UI | `app/web/overview_dashboard.py`, `app/web/overview_dashboard_helpers.py`, `app/web/pages/backtest.py`, `app/web/backtest_history.py`, `app/web/backtest_ui_components.py`, `app/web/backtest_candidate_review.py`, `app/web/backtest_candidate_review_helpers.py`, `app/web/backtest_portfolio_proposal.py`, `app/web/backtest_portfolio_proposal_helpers.py` | Overview 후보 / funnel / next action dashboard, Single / Compare / Candidate Review / Pre-Live 운영 기록 / Portfolio Proposal 주 흐름과 Operations Backtest Run History / Saved Portfolio 보조 재현 화면, 공용 status/route UI component |
