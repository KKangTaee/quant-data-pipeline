...
17. 자세한 코드 흐름은 `code_analysis/`, DB와 데이터 품질은 `docs/data/`, 결과 기록은 `backtest_reports/`에서 관리한다.
...
| Phase 27 Data integrity / backtest trust | missing data, stale data, common-date truncation, excluded ticker를 사용자가 놓치지 않게 하는 첫 surface를 구현했고 QA까지 완료했다. | `docs/data/DATA_QUALITY_AND_PIT_NOTES.md`, `code_analysis/BACKTEST_RUNTIME_FLOW.md`, `phases/phase27/` |
