...
| Phase 30 Portfolio proposal / pre-live monitoring | 최종 목표인 포트폴리오 구성 제안으로 가기 위해 후보 묶음과 paper/pre-live tracking surface가 필요하다. 구현 전 Phase 29 이후의 사용 흐름과 `backtest.py` 리팩토링 경계를 먼저 정리한다. | `phase25/`, `phase29/`, `backtest_reports/` |
