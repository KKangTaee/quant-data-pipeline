...
6. Phase 25는 live trading이 아니라 paper / watchlist / hold / re-review 운영 기록 체계를 준비하는 단계다.
7. 자세한 코드 흐름은 `code_analysis/`, DB와 데이터 품질은 `data_architecture/`, 결과 기록은 `backtest_reports/`에서 관리한다.
