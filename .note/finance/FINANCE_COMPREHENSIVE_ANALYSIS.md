...
| Backtest UI | `app/web/pages/backtest.py`, `app/web/pages/backtest_candidate_review.py` | Single / Compare / History / Saved Portfolio / Pre-Live Review / Portfolio Proposal 화면과 분리된 Candidate Review / Candidate Packaging 화면 |
...
| Web UI | `app/web/pages/backtest.py`, `app/web/pages/backtest_candidate_review.py` | Single / Compare / History / Saved Portfolio / Pre-Live Review / Portfolio Proposal 화면과 Candidate Review / Candidate Packaging 화면 |
