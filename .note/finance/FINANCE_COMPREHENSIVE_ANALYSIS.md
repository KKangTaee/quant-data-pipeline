...
10. Phase 29는 current candidate registry를 `Backtest > Candidate Review`에서 검토 보드로 읽고, 후보를 compare 또는 Pre-Live Review로 넘기며, Latest / History 결과를 후보 검토 초안으로 보내는 workflow를 추가했다.
