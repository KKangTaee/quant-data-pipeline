...
- 최초 기준 시점: 2026-03-11
- 최근 동기화 기준: 2026-05-04 / Phase 35 Final Review completion flow 보정
...
| Review / Proposal / Pre-Live | 결과를 진단하고 candidate note / registry / proposal draft / paper / watchlist / hold / re-review / validation pack / robustness preview / inline paper observation / final selection decision으로 관리한다 | Real-Money surface, Phase 25 / Phase 29 / Phase 30 / Phase 31 / Phase 32 / Phase 33 / Phase 34 / Phase 35 문서 |
...
3. 현재 제품 경로는 DB-backed runtime, Overview 후보 대시보드, Backtest UI, compare, Candidate Review, Operations Backtest Run History, saved replay, Pre-Live 운영 기록, Portfolio Proposal draft, Final Review validation / robustness / paper observation, Final Portfolio Selection Decision 저장 / review, 최종 판단 완료 단계까지 확장됐다.
