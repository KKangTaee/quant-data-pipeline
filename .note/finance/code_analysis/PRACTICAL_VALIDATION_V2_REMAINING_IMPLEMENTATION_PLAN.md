...
| 파일 | 역할 |
|---|---|
| `.note/finance/registries/PORTFOLIO_SELECTION_SOURCES.jsonl` | Backtest Analysis에서 Practical Validation으로 보낸 source |
| `.note/finance/registries/PRACTICAL_VALIDATION_RESULTS.jsonl` | Practical Validation 결과 |
| `.note/finance/registries/FINAL_PORTFOLIO_SELECTION_DECISIONS_V2.jsonl` | Final Review 최종 판단 |
| `.note/finance/registries/SELECTED_PORTFOLIO_MONITORING_LOG.jsonl` | Selected Dashboard에서 사용자가 명시 저장한 monitoring snapshot |
| `.note/finance/saved/SAVED_PORTFOLIO_MIXES.jsonl` | reusable saved mix setup |
