...
| `app/web/backtest_practical_validation_helpers.py` | Clean V2 portfolio selection source 생성, validation profile threshold 해석, 12개 Practical Diagnostics result 생성 / 저장 / Final Review handoff helper |
