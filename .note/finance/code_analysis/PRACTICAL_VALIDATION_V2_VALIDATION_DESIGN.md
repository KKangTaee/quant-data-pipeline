...
| asset allocation profile은 어떻게 고를 것인가? | 화면 표기는 방어형 / 균형형 / 성장형 / 전술·헤지형 / 사용자 지정으로 두고, 내부 id는 `conservative_defensive`, `balanced_core`, `growth_aggressive`, `hedged_tactical`, `custom`으로 저장 |
