...
- 현재 후보: `.note/finance/registries/CURRENT_CANDIDATE_REGISTRY.jsonl`
- 최종 선정 판단: `.note/finance/registries/FINAL_PORTFOLIO_SELECTION_DECISIONS*.jsonl`
- 저장된 weight setup: `.note/finance/saved/SAVED_PORTFOLIOS.jsonl`
