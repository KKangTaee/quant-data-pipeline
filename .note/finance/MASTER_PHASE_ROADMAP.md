...
현재 권고 reading:
- `Phase 18`
  - structural redesign first slice와 remaining backlog를 이해하는 implementation pivot
- `Phase 19`
  - 구조 옵션을 operator-facing contract로 정리한 cleanup phase
- `Phase 20`
  - current candidate -> compare -> weighted -> saved workflow를 practical하게 정리한 phase
- `Support Track`
