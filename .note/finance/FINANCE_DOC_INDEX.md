...
| 현재 active phase TODO | `.note/finance/phase28/PHASE28_CURRENT_CHAPTER_TODO.md` |
| Phase 28 계획 | `.note/finance/phase28/PHASE28_STRATEGY_FAMILY_PARITY_AND_CADENCE_COMPLETION_PLAN.md` |
| Phase 28 첫 작업 단위 | `.note/finance/phase28/PHASE28_STRATEGY_CAPABILITY_SNAPSHOT_FIRST_WORK_UNIT.md` |
| Phase 28 두 번째 작업 단위 | `.note/finance/phase28/PHASE28_HISTORY_REPLAY_PARITY_SECOND_WORK_UNIT.md` |
| Phase 28 세 번째 작업 단위 | `.note/finance/phase28/PHASE28_SAVED_PORTFOLIO_REPLAY_PARITY_THIRD_WORK_UNIT.md` |
| Phase 28 네 번째 작업 단위 | `.note/finance/phase28/PHASE28_COMPARE_AND_WEIGHTED_DATA_TRUST_FOURTH_WORK_UNIT.md` |
| Phase 28 다섯 번째 작업 단위 | `.note/finance/phase28/PHASE28_REAL_MONEY_GUARDRAIL_PARITY_FIFTH_WORK_UNIT.md` |
| Phase 28 QA checklist | `.note/finance/phase28/PHASE28_TEST_CHECKLIST.md` |
| Phase 28 이후 roadmap | `.note/finance/MASTER_PHASE_ROADMAP.md` |
...
- 현재는 Phase 28 구현이 완료되어, strategy family별 지원 범위와 cadence 차이, history / saved portfolio 재실행과 form 복원 가능성, compare / weighted data trust, Real-Money / Guardrail scope를 QA하면 된다.
...
| Phase 28 | `implementation_complete` | `manual_qa_pending` | Capability + Replay + Data Trust + Real-Money/Guardrail parity 구현 완료 | strategy family parity / cadence completion | `.note/finance/phase28/PHASE28_STRATEGY_FAMILY_PARITY_AND_CADENCE_COMPLETION_PLAN.md` |
