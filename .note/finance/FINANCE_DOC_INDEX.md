...
| 최근 완료 phase TODO | `.note/finance/phase25/PHASE25_CURRENT_CHAPTER_TODO.md` |
...
| Phase 25 QA checklist | `.note/finance/phase25/PHASE25_TEST_CHECKLIST.md` |
...
- Phase 25는 `complete` / `manual_qa_completed`로 닫혔고, live trading이 아니라
