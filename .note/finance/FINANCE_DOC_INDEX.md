...
| 최근 완료 phase TODO | `.note/finance/phase27/PHASE27_CURRENT_CHAPTER_TODO.md` |
| Phase 27 계획 | `.note/finance/phase27/PHASE27_DATA_INTEGRITY_AND_BACKTEST_TRUST_LAYER_PLAN.md` |
| Phase 27 첫 작업 단위 | `.note/finance/phase27/PHASE27_BACKTEST_DATA_TRUST_SUMMARY_FIRST_WORK_UNIT.md` |
| Phase 27 QA checklist | `.note/finance/phase27/PHASE27_TEST_CHECKLIST.md` |
| Phase 28 준비 | `.note/finance/phase27/PHASE27_NEXT_PHASE_PREPARATION.md` |
...
- 다음 예정 단계는 Phase 28 전략 family parity / cadence completion이다.
