...
| Phase 25 두 번째 작업 단위 | `.note/finance/phase25/PHASE25_PRE_LIVE_CANDIDATE_RECORD_CONTRACT_SECOND_WORK_UNIT.md` |
| Phase 25 세 번째 작업 단위 | `.note/finance/phase25/PHASE25_OPERATOR_REVIEW_WORKFLOW_THIRD_WORK_UNIT.md` |
| Phase 25 네 번째 작업 단위 | `.note/finance/phase25/PHASE25_PRE_LIVE_REVIEW_UI_FOURTH_WORK_UNIT.md` |
...
| Phase 25 | `implementation_complete` | `manual_qa_pending` | Pre-Live Review UI QA 필요 |
...
| `.note/finance/PRE_LIVE_CANDIDATE_REGISTRY.jsonl` | pre-live 운영 상태 append-only registry. 첫 row append 시 생성 |
...
| Phase 25 | `implementation_complete` | `manual_qa_pending` | 사용자 QA 필요 | pre-live operating system | `.note/finance/phase25/PHASE25_PRE_LIVE_OPERATING_SYSTEM_AND_DEPLOYMENT_READINESS_PLAN.md` |
