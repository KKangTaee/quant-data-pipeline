...
| 현재 active phase TODO | `.note/finance/phase27/PHASE27_CURRENT_CHAPTER_TODO.md` |
...
| Phase 27 QA checklist draft | `.note/finance/phase27/PHASE27_TEST_CHECKLIST.md` |
| Phase 27 이후 roadmap | `.note/finance/MASTER_PHASE_ROADMAP.md` |
...
- 현재는 Phase 27에서 데이터 신뢰성과 백테스트 결과 해석 표면을 강화하고 있다.
...
| Phase 27 | `active` | `not_ready_for_qa` | Data Trust Summary 첫 구현 진행 | data integrity / backtest trust | `.note/finance/phase27/PHASE27_DATA_INTEGRITY_AND_BACKTEST_TRUST_LAYER_PLAN.md` |
...
| Test checklist draft | `.note/finance/phase27/PHASE27_TEST_CHECKLIST.md` |
| Completion summary draft | `.note/finance/phase27/PHASE27_COMPLETION_SUMMARY.md` |
| Next phase preparation draft | `.note/finance/phase27/PHASE27_NEXT_PHASE_PREPARATION.md` |

한 줄 설명:

- Phase 27은 백테스트 결과를 더 좋게 만드는 phase가 아니라, 그 결과가 어떤 데이터 조건에서 나온 것인지 먼저 보이게 만드는 phase다.
