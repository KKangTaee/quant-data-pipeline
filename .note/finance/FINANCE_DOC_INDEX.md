...
| 현재 active phase TODO | `.note/finance/phase30/PHASE30_CURRENT_CHAPTER_TODO.md` |
| Phase 30 계획 | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_AND_PRE_LIVE_MONITORING_SURFACE_PLAN.md` |
| Phase 30 첫 작업 단위 | `.note/finance/phase30/PHASE30_PRODUCT_FLOW_REORIENTATION_AND_BACKTEST_REFACTOR_BOUNDARY_FIRST_WORK_UNIT.md` |
| Phase 30 두 번째 작업 단위 | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_CONTRACT_SECOND_WORK_UNIT.md` |
| Phase 30 세 번째 작업 단위 | `.note/finance/phase30/PHASE30_REGISTRY_IO_HELPER_REFACTOR_THIRD_WORK_UNIT.md` |
| Phase 30 네 번째 작업 단위 | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_DRAFT_UI_FOURTH_WORK_UNIT.md` |
| Phase 30 다섯 번째 작업 단위 | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_MONITORING_REVIEW_FIFTH_WORK_UNIT.md` |
| Phase 30 여섯 번째 작업 단위 | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_PRE_LIVE_FEEDBACK_SIXTH_WORK_UNIT.md` |
| Phase 30 일곱 번째 작업 단위 | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_PAPER_TRACKING_FEEDBACK_SEVENTH_WORK_UNIT.md` |
| Phase 30 QA checklist | `.note/finance/phase30/PHASE30_TEST_CHECKLIST.md` |
| Phase 30 이후 준비 초안 | `.note/finance/phase30/PHASE30_NEXT_PHASE_PREPARATION.md` |
| 최근 완료 phase QA checklist | `.note/finance/phase29/PHASE29_TEST_CHECKLIST.md` |
...
| Phase 8 | `complete` | `superseded_by_later_phase` | Phase 23에 흡수 | quarterly family expansion / operator polish | `.note/finance/phase8/PHASE8_QUARTERLY_STRATEGY_FAMILY_EXPANSION_PLAN.md` |
| Phase 9 | `complete` | `superseded_by_later_phase` | Phase 10/12/23/25에 흡수 | strict coverage policy / promotion gate | `.note/finance/phase9/PHASE9_STRICT_COVERAGE_POLICY_AND_PROMOTION_PLAN.md` |
...
| Phase 12 | `complete` | `superseded_by_later_phase` | Phase 13~15/25에 흡수 | strategy surface consolidation / real-money hardening | `.note/finance/phase12/PHASE12_REAL_MONEY_STRATEGY_PROMOTION_PLAN.md` |
| Phase 13 | `complete` | `superseded_by_later_phase` | Phase 25 Pre-Live로 재정의 | deployment readiness / probation | `.note/finance/phase13/PHASE13_DEPLOYMENT_READINESS_AND_PROBATION_PLAN.md` |
| Phase 14 | `complete` | `superseded_by_later_phase` | Phase 27~29에서 다룰 주제 | gate calibration / deployment workflow bridge | `.note/finance/phase14/PHASE14_REAL_MONEY_GATE_CALIBRATION_AND_DEPLOYMENT_WORKFLOW_PLAN.md` |
| Phase 15 | `complete` | `superseded_by_later_phase` | registry/report 흐름으로 흡수 | candidate quality improvement | `.note/finance/phase15/PHASE15_CANDIDATE_QUALITY_IMPROVEMENT_PLAN.md` |
...
| Phase 18 | `complete` | `superseded_by_later_phase` | 남은 구조 작업은 future option | larger structural redesign | `.note/finance/phase18/PHASE18_LARGER_STRUCTURAL_REDESIGN_PLAN.md` |
...
| Phase 26 | `complete` | `manual_qa_completed` | 없음 | foundation stabilization / backlog rebase | `.note/finance/phase26/PHASE26_FOUNDATION_STABILIZATION_AND_BACKLOG_REBASE_PLAN.md` |
| Phase 27 | `complete` | `manual_qa_completed` | 없음 | data integrity / backtest trust | `.note/finance/phase27/PHASE27_DATA_INTEGRITY_AND_BACKTEST_TRUST_LAYER_PLAN.md` |
| Phase 28 | `complete` | `manual_qa_completed` | Capability + Replay + Data Trust + Real-Money/Guardrail parity QA 완료 | strategy family parity / cadence completion | `.note/finance/phase28/PHASE28_STRATEGY_FAMILY_PARITY_AND_CADENCE_COMPLETION_PLAN.md` |
| Phase 29 | `complete` | `manual_qa_completed` | Candidate Review Board + Result Handoff + Review Notes + Registry Draft QA 완료 | candidate review / recommendation workflow | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_AND_RECOMMENDATION_WORKFLOW_PLAN.md` |
| Phase 30 | `implementation_complete` | `manual_qa_pending` | Product-flow 재정렬 + Portfolio Proposal 계약 정의 + registry I/O helper 분리 + Proposal Draft UI + Monitoring Review + Pre-Live Feedback + Paper Tracking Feedback 구현 | portfolio proposal / pre-live monitoring | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_AND_PRE_LIVE_MONITORING_SURFACE_PLAN.md` |
...
| 종류 | 문서 |
|---|---|
| Plan | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_AND_RECOMMENDATION_WORKFLOW_PLAN.md` |
| TODO | `.note/finance/phase29/PHASE29_CURRENT_CHAPTER_TODO.md` |
| First work unit | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_BOARD_FIRST_WORK_UNIT.md` |
| Second work unit | `.note/finance/phase29/PHASE29_RESULT_TO_CANDIDATE_REVIEW_HANDOFF_SECOND_WORK_UNIT.md` |
| Third work unit | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_NOTE_THIRD_WORK_UNIT.md` |
| Fourth work unit | `.note/finance/phase29/PHASE29_REVIEW_NOTE_TO_REGISTRY_DRAFT_FOURTH_WORK_UNIT.md` |
| Test checklist | `.note/finance/phase29/PHASE29_TEST_CHECKLIST.md` |
| Completion summary | `.note/finance/phase29/PHASE29_COMPLETION_SUMMARY.md` |
| Next phase preparation | `.note/finance/phase29/PHASE29_NEXT_PHASE_PREPARATION.md` |

한 줄 설명:

- Phase 29는 current candidate를 바로 투자 추천으로 확정하지 않고, 후보 검토 보드에서 읽은 뒤 compare / Pre-Live Review / Candidate Packaging 초안 / Candidate Review Note / registry draft로 넘기는 workflow를 만드는 phase다.
...
| 종류 | 문서 |
|---|---|
| Plan | `.note/finance/phase28/PHASE28_STRATEGY_FAMILY_PARITY_AND_CADENCE_COMPLETION_PLAN.md` |
| TODO | `.note/finance/phase28/PHASE28_CURRENT_CHAPTER_TODO.md` |
| First work unit | `.note/finance/phase28/PHASE28_STRATEGY_CAPABILITY_SNAPSHOT_FIRST_WORK_UNIT.md` |
| Second work unit | `.note/finance/phase28/PHASE28_HISTORY_REPLAY_PARITY_SECOND_WORK_UNIT.md` |
| Third work unit | `.note/finance/phase28/PHASE28_SAVED_PORTFOLIO_REPLAY_PARITY_THIRD_WORK_UNIT.md` |
| Fourth work unit | `.note/finance/phase28/PHASE28_COMPARE_AND_WEIGHTED_DATA_TRUST_FOURTH_WORK_UNIT.md` |
| Fifth work unit | `.note/finance/phase28/PHASE28_REAL_MONEY_GUARDRAIL_PARITY_FIFTH_WORK_UNIT.md` |
| Test checklist | `.note/finance/phase28/PHASE28_TEST_CHECKLIST.md` |
| Completion summary | `.note/finance/phase28/PHASE28_COMPLETION_SUMMARY.md` |
| Next phase preparation | `.note/finance/phase28/PHASE28_NEXT_PHASE_PREPARATION.md` |
...
| 종류 | 문서 |
|---|---|
| Plan | `.note/finance/phase27/PHASE27_DATA_INTEGRITY_AND_BACKTEST_TRUST_LAYER_PLAN.md` |
| TODO | `.note/finance/phase27/PHASE27_CURRENT_CHAPTER_TODO.md` |
| First work unit | `.note/finance/phase27/PHASE27_BACKTEST_DATA_TRUST_SUMMARY_FIRST_WORK_UNIT.md` |
| Test checklist | `.note/finance/phase27/PHASE27_TEST_CHECKLIST.md` |
| Completion summary | `.note/finance/phase27/PHASE27_COMPLETION_SUMMARY.md` |
| Next phase preparation | `.note/finance/phase27/PHASE27_NEXT_PHASE_PREPARATION.md` |
...
| Rebase result | `.note/finance/phase26/PHASE26_BACKLOG_REBASE_AND_FOUNDATION_GAP_MAP.md` |
| Test checklist | `.note/finance/phase26/PHASE26_TEST_CHECKLIST.md` |
| Completion summary | `.note/finance/phase26/PHASE26_COMPLETION_SUMMARY.md` |
