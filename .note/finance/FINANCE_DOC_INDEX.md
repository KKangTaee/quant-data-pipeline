...
| 현재 active phase TODO | `.note/finance/phase29/PHASE29_CURRENT_CHAPTER_TODO.md` |
...
| Phase 29 이후 roadmap | `.note/finance/MASTER_PHASE_ROADMAP.md` |
...
- 현재는 Phase 29 `Candidate Review And Recommendation Workflow`에서 `Backtest > Candidate Review`,
  Latest / History 후보 검토 초안 handoff, Candidate Review Note 저장,
  Review Note -> Current Candidate Registry Draft 흐름을 QA하면 된다.
...
| Phase 29 | `implementation_complete` | `manual_qa_pending` | Candidate Review Board + Result Handoff + Review Notes + Registry Draft 구현 완료, 사용자 QA 대기 | candidate review / recommendation workflow | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_AND_RECOMMENDATION_WORKFLOW_PLAN.md` |
