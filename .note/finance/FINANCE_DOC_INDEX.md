...
| Phase 25 | `active` | `not_ready_for_qa` | operator workflow 진행 | pre-live operating system | `.note/finance/phase25/PHASE25_PRE_LIVE_OPERATING_SYSTEM_AND_DEPLOYMENT_READINESS_PLAN.md` |
