...
- `.note/finance/phase22/PHASE22_PORTFOLIO_LEVEL_CANDIDATE_CONSTRUCTION_PLAN.md`
  ...
  - 또한 Phase 22가 실전 투자 포트폴리오 선정이 아니라
    portfolio 구성 / 저장 / replay / 비교 workflow 개발 검증 phase라는 경계를 명시한다
...
- `.note/finance/phase23/PHASE23_COMPARE_VARIANT_IMMEDIATE_REFRESH_FOURTH_WORK_UNIT.md`
  - `Phase 23` 네 번째 작업 단위로,
    Compare 화면의 Annual / Quarterly variant 선택을 각 strategy box 안에 배치하고,
...
- `.note/finance/backtest_reports/phase21/PHASE21_VALUE_ANCHOR_AND_ALTERNATIVE_RERUN_FIRST_PASS.md`
  - `Value` current anchor와 lower-MDD alternative를 같은 validation frame에서 다시 돌려,
    current anchor 유지 여부와 lower-MDD alternative의 weaker-gate status를 확인한 first-pass report
