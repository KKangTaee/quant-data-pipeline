...
| 최근 완료 phase TODO | `.note/finance/phase29/PHASE29_CURRENT_CHAPTER_TODO.md` |
| Phase 29 계획 | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_AND_RECOMMENDATION_WORKFLOW_PLAN.md` |
| Phase 29 첫 작업 단위 | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_BOARD_FIRST_WORK_UNIT.md` |
| Phase 29 두 번째 작업 단위 | `.note/finance/phase29/PHASE29_RESULT_TO_CANDIDATE_REVIEW_HANDOFF_SECOND_WORK_UNIT.md` |
| Phase 29 세 번째 작업 단위 | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_NOTE_THIRD_WORK_UNIT.md` |
| Phase 29 네 번째 작업 단위 | `.note/finance/phase29/PHASE29_REVIEW_NOTE_TO_REGISTRY_DRAFT_FOURTH_WORK_UNIT.md` |
| Phase 29 QA checklist | `.note/finance/phase29/PHASE29_TEST_CHECKLIST.md` |
| Phase 29 이후 준비 문서 | `.note/finance/phase29/PHASE29_NEXT_PHASE_PREPARATION.md` |
...
- 다음에는 Phase 30을 바로 기능 구현으로 열기보다,
  Phase 29 이후 기준의 사용 흐름 재정렬과 `backtest.py` 리팩토링 경계 검토를 먼저 한다.
...
| Phase 30 | `planned` | `not_ready_for_qa` | Phase 29 이후. 구현 전 사용 흐름 재정렬과 리팩토링 경계 검토 필요 | portfolio proposal / pre-live monitoring | `.note/finance/MASTER_PHASE_ROADMAP.md` |
