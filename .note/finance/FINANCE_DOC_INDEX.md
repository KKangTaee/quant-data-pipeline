...
- Phase 30을 읽을 때는 전체 목표와 작업 단위를 분리해서 본다.
  ...
  네 번째 작업은 Proposal Draft UI / persistence다.
...
| Phase 30 | `active` | `not_ready_for_qa` | Product-flow 재정렬 + Portfolio Proposal 계약 정의 + registry I/O helper 분리 + Proposal Draft UI 구현 | portfolio proposal / pre-live monitoring | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_AND_PRE_LIVE_MONITORING_SURFACE_PLAN.md` |
