...
| Phase 30 QA checklist 초안 | `.note/finance/phase30/PHASE30_TEST_CHECKLIST.md` |
...
- Phase 30 `Portfolio Proposal And Pre-Live Monitoring Surface`는 active 상태다.
...
- Phase 30을 읽을 때는 전체 목표와 작업 단위를 분리해서 본다.
  ...
  여섯 번째 작업은 Proposal Pre-Live Feedback이다.
...
| Phase 30 | `active` | `not_ready_for_qa` | Product-flow 재정렬 + Portfolio Proposal 계약 정의 + registry I/O helper 분리 + Proposal Draft UI + Monitoring Review + Pre-Live Feedback 구현 | portfolio proposal / pre-live monitoring | `.note/finance/phase30/PHASE30_PORTFOLIO_PROPOSAL_AND_PRE_LIVE_MONITORING_SURFACE_PLAN.md` |
