...
- Phase 29는 current candidate를 바로 투자 추천으로 확정하지 않고, 후보 검토 보드에서 읽은 뒤 compare / Pre-Live Review / 후보 검토 초안 / Candidate Review Note / registry draft로 넘기는 workflow를 만드는 phase다.
