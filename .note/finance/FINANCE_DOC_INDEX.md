...
| Phase 29 | `active` | `manual_qa_pending` | Candidate Review Board + Result Handoff + Review Notes + Registry Draft 구현 완료 | candidate review / recommendation workflow | `.note/finance/phase29/PHASE29_CANDIDATE_REVIEW_AND_RECOMMENDATION_WORKFLOW_PLAN.md` |
