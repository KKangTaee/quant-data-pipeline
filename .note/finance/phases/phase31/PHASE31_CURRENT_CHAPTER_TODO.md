...
| 구분 | 의미 | 현재 상태 |
|---|---|---|
| Phase 31 전체 목표 | Portfolio Risk / Live Readiness validation pack을 만든다 | `complete` |
...
- `completed` targeted manual validation
  - 사용자가 Phase 31 manual QA closeout을 승인했다.
...
사용자는 `PHASE31_TEST_CHECKLIST.md` 기준으로 `Backtest > Portfolio Proposal`의 Validation Pack QA를 완료했다.
