...
- 확인 문서:
  - `.note/finance/phases/phase30/PHASE30_PORTFOLIO_PROPOSAL_AND_PRE_LIVE_MONITORING_SURFACE_PLAN.md`
  - `.note/finance/phases/phase30/PHASE30_CURRENT_CHAPTER_TODO.md`
...
- 확인 위치:
  ...
  - `.note/finance/phases/phase30/PHASE30_REGISTRY_IO_HELPER_REFACTOR_THIRD_WORK_UNIT.md`
- 체크 항목:
...
- 확인 위치:
  ...
  - `.note/finance/phases/phase30/PHASE30_PORTFOLIO_PROPOSAL_DRAFT_UI_FOURTH_WORK_UNIT.md`
- 체크 항목:
...
- 확인 위치:
  ...
  - `.note/finance/phases/phase30/PHASE30_PORTFOLIO_PROPOSAL_MONITORING_REVIEW_FIFTH_WORK_UNIT.md`
- 체크 항목:
...
- 확인 위치:
  ...
  - `.note/finance/phases/phase30/PHASE30_PORTFOLIO_PROPOSAL_PRE_LIVE_FEEDBACK_SIXTH_WORK_UNIT.md`
- 체크 항목:
  - [ ] 저장된 proposal이 없을 때 빈 상태 안내가 보이는지
...
- 확인 위치:
  ...
  - `.note/finance/phases/phase30/PHASE30_PORTFOLIO_PROPOSAL_PAPER_TRACKING_FEEDBACK_SEVENTH_WORK_UNIT.md`
- 체크 항목:
  - [ ] 저장된 proposal이 없을 때 빈 상태 안내가 보이는지
