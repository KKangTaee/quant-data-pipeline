...
Phase 32 구현은 완료되었고, 이제 사용자가 checklist 기준으로 manual QA를 진행할 단계다.
...
사용자가 `.note/finance/phases/phase32/PHASE32_TEST_CHECKLIST.md` 기준으로 QA를 완료하면,
Phase 32를 `complete / manual_qa_completed`로 닫을 수 있다.
