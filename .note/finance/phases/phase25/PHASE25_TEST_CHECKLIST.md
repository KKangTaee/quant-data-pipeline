...
- 확인 위치:
  - `.note/finance/phases/phase25/PHASE25_PRE_LIVE_OPERATING_SYSTEM_AND_DEPLOYMENT_READINESS_PLAN.md`
  - `.note/finance/phases/phase25/PHASE25_PRE_LIVE_BOUNDARY_AND_OPERATING_FRAME_FIRST_WORK_UNIT.md`
- 체크 항목:
...
- 확인 위치:
  - `.note/finance/phases/phase25/PHASE25_PRE_LIVE_CANDIDATE_RECORD_CONTRACT_SECOND_WORK_UNIT.md`
...
- 확인 위치:
  - `.note/finance/phases/phase25/PHASE25_OPERATOR_REVIEW_WORKFLOW_THIRD_WORK_UNIT.md`
  - `.note/finance/phases/phase25/PHASE25_PRE_LIVE_REVIEW_UI_FOURTH_WORK_UNIT.md`
  - `.note/finance/operations/PRE_LIVE_CANDIDATE_REGISTRY_GUIDE.md`
  - `plugins/quant-finance-workflow/scripts/manage_pre_live_candidate_registry.py`
- 확인 방법:
...
- 확인 문서:
  - `.note/finance/phases/phase25/PHASE25_CURRENT_CHAPTER_TODO.md`
  - `.note/finance/phases/phase25/PHASE25_COMPLETION_SUMMARY.md`
  - `.note/finance/phases/phase25/PHASE25_NEXT_PHASE_PREPARATION.md`
