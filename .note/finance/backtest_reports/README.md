...
3. phase 문서에는 그 report를 링크만 남긴다

이렇게 하면:

- phase 문서는 작업 흐름을 보기 좋고
- backtest report 폴더는 결과 검색이 쉬워진다
...
기존 phase 문서들을 지금 당장 이 폴더로 모두 옮기지는 않는다.

대신 앞으로는:

- 새로 만드는 결과 중심 문서부터 이 폴더에 두고
- 필요하면 나중에 phase 문서에서 많이 참조되는 것만 천천히 재배치한다
