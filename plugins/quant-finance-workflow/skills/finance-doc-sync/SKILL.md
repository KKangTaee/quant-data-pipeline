...
- Product/project maps: `.note/finance/docs/PRODUCT_DIRECTION.md`, `.note/finance/docs/PROJECT_MAP.md`
- Architecture and flow docs: `.note/finance/docs/architecture/`, `.note/finance/docs/flows/`
- Data / DB docs: `.note/finance/docs/data/`
- Runbooks and agent notes: `.note/finance/docs/runbooks/`, `.note/finance/agent/`
- Active work: `.note/finance/tasks/active/`, `.note/finance/phases/active/`
- Root handoff logs: `.note/finance/WORK_PROGRESS.md`, `.note/finance/QUESTION_AND_ANALYSIS_LOG.md`
- Roadmap/index/glossary: `.note/finance/docs/ROADMAP.md`, `.note/finance/docs/INDEX.md`, `.note/finance/docs/GLOSSARY.md`
- Backtest reports: `.note/finance/reports/backtests/`
