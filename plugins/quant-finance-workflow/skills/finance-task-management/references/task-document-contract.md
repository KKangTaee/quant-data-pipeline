...
- `.note/finance/WORK_PROGRESS.md`: 3-5 concise lines per meaningful milestone
- `.note/finance/QUESTION_AND_ANALYSIS_LOG.md`: durable analysis result and decision, not every exchange
...
If a phase is needed, keep it as a higher-level integration layer under `.note/finance/phases/active/<phase-name>/` and keep execution details inside active task docs.
