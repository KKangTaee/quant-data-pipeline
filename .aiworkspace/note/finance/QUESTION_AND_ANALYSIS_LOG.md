...
- current candidate summary:
  - Reference decision: [reference-center-react-v1-20260720](./tasks/active/reference-center-react-v1-20260720/DESIGN.md). Guide와 Glossary를 단일 Search-first Hybrid React Reference로 통합하고 legacy·개발자 용어와 로그 surface를 사용자 UI에서 제외한다. Written spec review 후 구현 계획으로 전환한다.
