...
| `active/2026-06-backtest-analysis-commercial-ux/` | Backtest Analysis의 과도한 안내 / reference / readiness 흐름을 줄이고 상용형 backtest workbench UX로 재정리하기 위한 현재 제품 audit, 외부 benchmark, 단계별 개발 가이드 |
