# Operations Workspace Restructure Research Plan

## Why This Work Exists

Operations 탭의 현재 기능을 감사하고 Selected Portfolio Dashboard 위치, legacy 운영 화면 정리, 외부 벤치마크 기반 운영/모니터링 UX 개편 가이드라인을 도출한다.
