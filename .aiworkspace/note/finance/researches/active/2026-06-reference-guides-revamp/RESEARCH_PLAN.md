# Reference Guides Product Revamp Research Plan

## Why This Work Exists

Reference > Guides를 현재 finance console 흐름에 맞는 user-facing workflow guide / help center로 개편하기 위한 제품 audit, benchmark, UX/UI pattern, 단계별 개발 가이드.
