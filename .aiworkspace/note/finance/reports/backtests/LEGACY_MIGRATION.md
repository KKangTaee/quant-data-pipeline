...
기존 `.aiworkspace/note/finance/backtest_reports/phase*/` 구조는 phase 진행 기록과 backtest 결과 report가 강하게 묶여 있었다.
...
- 기존: `.aiworkspace/note/finance/backtest_reports/`
- 신규: `.aiworkspace/note/finance/reports/backtests/`
- legacy phase archive: `.aiworkspace/note/finance/reports/backtests/archive/legacy_phase/`
