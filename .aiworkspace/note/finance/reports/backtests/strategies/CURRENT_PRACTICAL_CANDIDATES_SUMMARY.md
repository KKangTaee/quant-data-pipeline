...
- 2026-05-05 기준 GTAA 보완 sleeve로 다시 볼 후보는:
  - `QQQ, SOXX, XLE, XLU, GLD`
  - `Interval = 12`
  - `Benchmark = SPY`
- 결과:
  - `CAGR = 17.55%`
  ...
  - `real_money_candidate / paper_probation / paper_only`
- GTAA mix:
  - `GTAA 70 / EW 30`: `CAGR = 18.74%`, `MDD = -10.30%`, `Sharpe = 2.51`
  - `GTAA 60 / EW 40`: `CAGR = 18.52%`, `MDD = -10.04%`, `Sharpe = 2.54`
- 해석:
  - Equal Weight 단독 `MDD <= 15%`와 SPY benchmark 10단계 gate를 동시에 만족하는 후보는 아직 찾지 못했다.
  - 다만 GTAA와 섞은 전체 포트폴리오 기준으로는 MDD 15% 이하와 높은 Sharpe를 동시에 만족한다.

바로 열 문서:

- [EQUAL_WEIGHT.md](/Users/taeho/Project/quant-data-pipeline-worktrees/phase/.aiworkspace/note/finance/reports/backtests/strategies/EQUAL_WEIGHT.md)
- [EQUAL_WEIGHT_BACKTEST_LOG.md](/Users/taeho/Project/quant-data-pipeline-worktrees/phase/.aiworkspace/note/finance/reports/backtests/strategies/EQUAL_WEIGHT_BACKTEST_LOG.md)
...
- [PHASE16_CURRENT_CHAPTER_TODO.md](/Users/taeho/Project/quant-data-pipeline/.aiworkspace/note/finance/phases/phase16/PHASE16_CURRENT_CHAPTER_TODO.md)
- [BACKTEST_REPORT_INDEX.md](/Users/taeho/Project/quant-data-pipeline-worktrees/phase/.aiworkspace/note/finance/reports/backtests/INDEX.md)
- [WEIGHTED_PORTFOLIO_REPLAY_VALIDATION.md](/Users/taeho/Project/quant-data-pipeline-worktrees/phase/.aiworkspace/note/finance/reports/backtests/validation/runtime/WEIGHTED_PORTFOLIO_REPLAY_VALIDATION.md)
