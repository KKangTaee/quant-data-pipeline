...
현재 Selection 주 흐름의 필수 저장 단계는 아니다.
...
| `PRE_LIVE_CANDIDATE_REGISTRY.jsonl` | pre-live / paper tracking / watchlist 운영 상태 기록 | Final Review 이전 운영 기록 |
...
| `FINAL_PORTFOLIO_SELECTION_DECISIONS_V1.jsonl` | 기존 Final Review V1 판단 기록 | current dashboard source-of-truth가 아님 |
