...
| --- | --- | --- |
| Source map | 현재 concentration / overlap / correlation / risk contribution evidence가 어디에 있는지 확인 | Practical Validation diagnostics, provider context, look-through board, robustness lab, final review gate |
...
실제 파일 변경은 11-1 source map / gap audit 후 결정한다.
