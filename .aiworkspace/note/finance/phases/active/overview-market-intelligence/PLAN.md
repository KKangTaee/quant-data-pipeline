...
- earnings calendar production collector
...
- Overview의 refresh button은 직접 scraping하지 않고, 현재 slice에서는 DB-backed snapshot reload만 담당한다.

## First Build Done Criteria

- `Market Movers`, `Sector / Industry`, `Events`, `Candidate Ops` tab이 생긴다.
- `Market Movers`는 Coverage 1000 / 2000, daily / weekly / monthly, Top N을 지원한다.
...
- FOMC official calendar collector / storage / Events tab 표시
- Earnings free-source prototype provider decision
- Earnings ingestion and persistence
