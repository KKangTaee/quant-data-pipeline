...
| Earnings source is unstable or unofficial | High | Prototype rows use `source=yfinance_calendar`, `confidence=0.65`, raw payload evidence, and bounded symbol sets. |
