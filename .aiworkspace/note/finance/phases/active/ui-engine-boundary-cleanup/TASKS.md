...
| `7. practical-validation-diagnostics-split` | 큰 diagnostics service 책임 분할 | In Progress | `7-01` source/profile, `7-02` curve context helper 분리 완료; 다음은 stress/sensitivity helper 후보 |
