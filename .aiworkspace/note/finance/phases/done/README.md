...
오래된 phase 문서를 그대로 모두 보존하지 않고,
다음 작업에 필요한 결과, 검증 상태, 남은 리스크만 요약해서 남기는 것을 기본으로 한다.

Full phase board folders may still be retained under `.aiworkspace/note/finance/phases/active/`.
Current active phase 판정은 `.aiworkspace/note/finance/phases/active/STATUS_MANIFEST.md`, active README, roadmap을 우선한다.

## Completed

- [Investability Decision Foundation](./investability-decision-foundation.md)
