...
Market Research 상단은 eyebrow·실제 `<h1>`·설명·content-width family rail·선택 family의 local view rail을 하나의 React surface로 렌더링한다. desktop에서는 내용 너비로 유지하고 420px에서는 family 3열·view 2열로 접히며, drawer와 sticky navigation은 사용하지 않는다.
