...
| `app/runtime/backtest_runner_catalog.py` | Backtest strategy key / display name / runtime owner catalog. execution / compare service가 result bundle meta에 runner ownership을 붙일 때 사용한다 |
