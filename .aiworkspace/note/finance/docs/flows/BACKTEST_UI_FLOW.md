...
| `app/web/backtest_final_review.py` | Final Review 화면 render. Practical Validation Gate 통과 후보 Candidate Board priority / review queue, 선택 후보 Decision Cockpit, 최종 판단 기록 checklist / route guide, Evidence Appendix의 Validation / Robustness / Paper Observation / Investability Evidence Packet read-only 확인, saved final decision review ledger, Decision Dossier download |
