...
| `app/web/overview_ui_components.py` | Overview 전용 visual token, Market Context brief/cockpit row-list renderer, Market Movers refresh surface / metadata strip, Events summary/source/agenda/calendar/quality components, market session banner render |
