...
| `app/services/backtest_practical_validation_diagnostics.py` | Streamlit-free Practical Validation diagnostics service. Compact curve snapshot / diagnostics orchestration / 12개 Practical Diagnostics result를 만든다 |
