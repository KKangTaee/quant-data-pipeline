...
- 전략별 cadence, data trust, selection history, Real-Money / Guardrail, history / replay 지원 차이는 각 전략 입력 그룹, Latest Backtest Run, Selection History, Practical Validation / Final Review gate에서 필요할 때 확인한다.
