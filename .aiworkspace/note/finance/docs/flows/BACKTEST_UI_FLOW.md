...
| `app/web/backtest_common.py` | Backtest 공용 preset, universe / real-money / guardrail input, strict preset basis display model, Price Freshness Preflight model, strict factor readiness action model, legacy compatibility helper. Page shell은 신규 `backtest_state.py` boundary를 우선 사용한다 |
