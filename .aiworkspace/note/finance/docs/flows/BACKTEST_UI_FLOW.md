...
| `app/web/operations_overview.py` | `Operations > Operations Overview` / `Operations Console` landing page. Today action queue, Portfolio Monitoring / System Data Health primary lane, and no-live approval / order / auto rebalance boundary를 표시한다 |
