...
Workspace > Ingestion
  ...
  -> holdings / reported changes / sector exposure
  -> symbol or CUSIP reverse lookup
...
| Read model / caveats | `app/services/institutional_portfolios.py` |
| Streamlit surface | `app/web/institutional_portfolios.py`, `app/web/streamlit_app.py` |
