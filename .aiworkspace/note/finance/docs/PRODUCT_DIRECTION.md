...
- Operations는 Operations Console을 입구로 삼고, Portfolio Monitoring과 System / Data Health만 사용자-facing 운영 탭으로 둔다. Operations Console은 archive / development-history decision table을 운영 화면에 노출하지 않으며, 과거 데이터 / helper code 삭제는 별도 audit 전까지 하지 않는다.
