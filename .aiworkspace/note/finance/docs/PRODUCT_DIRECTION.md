...
| Research | Market Research | 현재 관측 국면·최근 변화·전환 확인 조건을 포함한 경기 국면과 독립 물가·정책 경로, 선물 매크로 재가격화·반대 근거·조건부 시나리오, 심리, 일정, S&P 500 가치평가, 변동 종목과 미국 개별 종목을 기준일·source와 함께 조사한다. |
| Research | Institutional Holdings | delayed SEC Form 13F로 기관별 allocation·보유 변화·섹터 노출과 종목별 보유 기관을 탐색하고, 직전 보고 포트폴리오의 다음 분기·공개 후 추종 성과 proxy를 coverage와 함께 검토한다. |
