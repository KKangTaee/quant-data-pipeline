...
| `nyse_symbol_lifecycle` | symbol lifecycle / historical universe / delisting evidence. current listing snapshot은 partial evidence이며, requested period를 덮는 historical / delisting source가 있어야 survivorship PASS 근거가 된다 |
