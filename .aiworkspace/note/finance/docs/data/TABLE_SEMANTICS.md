...
## `institutional_13f_manager`, `institutional_13f_filing`, `institutional_13f_holding`, `institutional_13f_cusip_symbol_map`
...
- sector / industry exposure는 row에 있는 field 또는 CUSIP-symbol mapping / future enrichment를 사용하며, 없으면 `Unmapped`로 표시한다.
