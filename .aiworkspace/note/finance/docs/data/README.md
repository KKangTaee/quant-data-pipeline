...
- Market Movers `시장 관심`은 selected-symbol investigation evidence only다. V1은 analyst / target-change pages, public news/search leads, SEC filing metadata, and SEC 13F references를 원문 링크 또는 세션 전용 metadata로 다루며 article body, analyst report body, filing body, commercial source content, or 13F holdings rows를 저장하지 않는다.
