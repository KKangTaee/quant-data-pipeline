...
| `market_event_calendar` | Overview Events calendar snapshot for FOMC, macro releases, earnings, and other market events. Macro rows use official BLS / BEA schedule sources; earnings rows carry source validation and lifecycle status metadata. |
