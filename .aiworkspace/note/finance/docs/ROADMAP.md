...
- Phase 8의 source review와 Symbol Directory snapshot ingestion은 완료됐다. 다음 task는 `sec-cik-exchange-crosscheck-v1`로 SEC current CIK / ticker / exchange association을 lifecycle identity 보조 evidence로 연결한다.
