...
| Market Research | 관측 기반 현재 국면·최근 변화·조건부 전환 감시 경제 사이클, 선물 매크로 재가격화·반대 근거·조건부 시나리오, 심리, 일정, S&P 500, Market Movers, 미국 개별 종목의 3-family / 7-view research | context-only, Futures Macro 5D 확률·가격 목표와 미래 월별 국면 예측·validation / monitoring signal 아님 |
