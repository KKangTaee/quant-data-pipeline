...
| `app/runtime/backtest/runners/strict_factor.py` | Strict quality / value / quality-value annual and quarterly runtime implementation. `app.runtime.backtest`가 기존 public import path를 위해 runner and strict helper functions를 re-export한다 |
