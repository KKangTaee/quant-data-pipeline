...
| `app/services/backtest_practical_validation_source.py` | Streamlit-free Practical Validation validation profile / selection source builder / source component table / compact selection history helper. result bundle, run history row, saved mix, weighted mix를 current selection source contract로 변환 |
