...
| `app/web/backtest_practical_validation/workspace_panel.py` | `practical_validation_decision_workspace_v1` 기반 `context / decision` two-surface Streamlit fallback과 legacy Flow 3 compatibility renderer를 소유한다 |
