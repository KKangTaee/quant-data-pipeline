...
| `app/web/components/backtest_portfolio_mix_workspace/` | current Portfolio Mix React/Vite presentation. `구성/공통 기준 -> 역할/비중 -> 실행/해석 -> 저장/Level2` 네 단계, saved shelf, responsive/ResizeObserver와 접근성만 소유한다 |
