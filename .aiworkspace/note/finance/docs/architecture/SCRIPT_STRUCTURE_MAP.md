...
| `app/web/backtest_result_display.py` | Backtest 결과 공용 display, summary / chart / data trust / Data Trust price refresh action button / 실전성 검증 handoff / compact `검증 신호 · Policy Signals` / selection history / compare result render wrapper |
