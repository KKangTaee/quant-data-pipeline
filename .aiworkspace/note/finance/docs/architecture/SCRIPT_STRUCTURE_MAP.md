...
| `app/services/backtest_temporal_validation.py` | Streamlit-free temporal validation helper. benchmark-aligned walk-forward rolling excess return, drawdown gap, source strength, compact storage boundary evidence를 담당 |
