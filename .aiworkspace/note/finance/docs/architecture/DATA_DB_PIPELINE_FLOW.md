...
| `app/services/overview/nasdaq100_valuation.py` / `market_context_valuation.py` | QQQ 단위 Nasdaq read model과 S&P/Nasdaq failure isolation 경계. S&P READY를 Nasdaq coverage failure가 가리지 않는다 |
