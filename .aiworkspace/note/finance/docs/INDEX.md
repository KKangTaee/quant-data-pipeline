...
- Current active Market Research UX task: [Market Research IA Redesign V1 2026-07-22](../tasks/active/market-research-ia-redesign-v1-20260722/STATUS.md) — Today 이후 기존 Overview를 `시장 환경 | 지수 가치평가 | 종목 리서치` deep-research workspace로 재정의하는 written spec 검토 단계다. 구현 roadmap은 `0/4차`이며 user spec approval 전에는 code work를 시작하지 않는다.
