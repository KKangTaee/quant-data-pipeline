...
- Current active task: [Overview Sentiment CNN·AAII Balanced V1 2026-07-19](../tasks/active/overview-sentiment-cnn-aaii-v1-20260719/STATUS.md) — 전체 잠정 roadmap `1/4차` 기능과 승인된 시각 polish·actual desktop/420px QA를 완료했다. 다음은 2차 장기 이력·발표 당시 값 품질 점검이며 1W/1M 예측은 PIT 검증 전까지 제공하지 않는다.
- Latest completed task: [Portfolio Monitoring Initial Setting Correction V1 2026-07-21](../tasks/active/portfolio-monitoring-initial-setting-correction-v1-20260721/STATUS.md) — direct-stock fixed-shares의 최초 요청 시작일과 수량을 한 번에 append-only 정정하고, 새 DB 시장일·종가·최초 투자금부터 개별/그룹 성과를 다시 계산한다. 전체 `4/4차`를 완료했다.
