...
진행 중 기록은 `.aiworkspace/note/finance/tasks/active/<task>/` 또는 `.aiworkspace/note/finance/phases/active/<phase>/`에 두고,
...
| 위치 | 역할 |
|---|---|
| `.aiworkspace/note/finance/phases/active/` | Main phase worktree가 관리하는 phase 단위 계획과 통합 기록 |
