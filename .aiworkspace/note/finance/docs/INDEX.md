...
- Current Operations simplification task: [Operations Portfolio Monitoring Only V1 2026-07-19](../tasks/active/operations-portfolio-monitoring-only-v1-20260719/STATUS.md) — 중복 Operations Overview와 사용하지 않는 System/Data Health를 제거하고 Operations를 Portfolio Monitoring 단일 사용자 화면으로 정리한다. Ingestion 기록·로그·failure 기능과 저장 artifact는 보존한다.
