...
- Current active task: [US Stock Turnaround Analysis V1 2026-07-15](../tasks/active/overview-market-context-us-stock-turnaround-analysis-v1-20260715/STATUS.md) — written spec review. 미국 개별주식 내부에 `PER 상대가치 | 전환 분석` selector를 두고, selected company의 filing-aware discrete-quarter 매출·margin·OCF·FCF·EPS, cash runway·debt·dilution risk, stage-appropriate valuation readiness를 표시한다. V1은 selected-company analysis이며 universe-wide screener/peer ranking은 후속이다.
