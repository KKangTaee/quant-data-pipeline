...
- Current Operations follow-up: [Portfolio Monitoring Chart Zoom / Pan V1 2026-07-19](../tasks/active/portfolio-monitoring-chart-zoom-pan-v1-20260719/STATUS.md) — 구현과 자동 회귀는 완료했으며 전체 `2/3차`. 실제 desktop wheel/drag/reset과 420px 버튼/overflow Browser QA가 남아 있다.
