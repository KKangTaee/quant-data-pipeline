...
- Latest completed Market Research UX task: [Market Research Top Navigation Visual Polish V1 2026-07-22](../tasks/active/market-research-top-navigation-visual-polish-v1-20260722/STATUS.md) — 3-family/7-view IA와 deep link는 유지하고 상단을 compact semantic header, content-width family rail, bounded local view surface로 정리했다. 전체 `3/3차`와 desktop·760px·420px actual Browser QA를 완료했으며 drawer/sticky는 추가하지 않았다.
- Previous completed Market Research UX task: [Market Research IA Redesign V1 2026-07-22](../tasks/active/market-research-ia-redesign-v1-20260722/STATUS.md) — Today 이후 기존 Overview를 `시장 환경 | 지수 가치평가 | 종목 리서치` 3-family/7-view deep-research workspace로 재정의했다. page-global session/reference를 제거하고 module-local metadata와 Market Movers → 개별 종목 inline handoff를 전체 `4/4차` 및 desktop·760px·420px actual Browser QA로 완료했다.
