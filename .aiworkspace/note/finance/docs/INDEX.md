...
- Current active task: [Overview Sentiment History PIT V2 2026-07-20](../tasks/active/overview-sentiment-history-pit-v2-20260720/STATUS.md) — 전체 잠정 roadmap `2/4차`. source별 immutable 수집 당시 기록, UTC known-at 조회, 24시간 자동 수집, full-history 그래프와 desktop/420px QA를 완료했다. 다음은 3차 독립 데이터 후보 검토이며 1W/1M은 4차 chronological PIT 검증 전까지 비공개다.
