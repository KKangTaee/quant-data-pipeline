...
기본 화면은 이 관측에서 가장 강한 5D 핵심축 또는 1D 새 충격을 골라 유력 해석,
반대 근거와 지속·무효화 조건을 표시한다. 완료 세션 snapshot과 과거 5D 검증/history는
기존 daily-only owner가 호환성·shadow research용으로 계속 담당하지만 primary UI에는 노출하지 않고,
