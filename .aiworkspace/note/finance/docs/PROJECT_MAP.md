...
| `app/web/backtest_final_review.py` | Final Review screen render, Practical Validation Gate-passed Candidate Board, selected-source Decision Cockpit, hidden blocked validation count, investability packet display, look-through / Robustness Lab summary, final decision input, saved final decision review, decision dossier download |
