...
| `app/web/operations_overview.py` | Operations Console landing page render와 Streamlit-free read model. selected dashboard summary와 run health를 읽어 today action queue, Portfolio Monitoring / System Data Health primary lane, removed archive tab decision, no-live boundary를 표시 |
