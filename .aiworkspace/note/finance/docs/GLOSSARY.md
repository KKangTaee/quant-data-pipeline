...
### 예시 / 필요 상황
- 이 `codex/phase` worktree처럼 phase 계획과 문서 구조 개편을 담당하는 세션
...
### 예시 / 필요 상황
- `codex/candidate-search`에서 후보 탐색과 재검증을 수행하는 경우
- `codex/ux-ui-polishing`에서 phase 범위 밖 UX polish를 수행하는 경우
