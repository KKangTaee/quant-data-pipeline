...
- V5 complete: added boundary guard contracts for Overview service surfaces, component surfaces, active page / tab modules, and the thin compatibility wrapper.
