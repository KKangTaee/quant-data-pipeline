...
| Yahoo 1d intraday response is empty for active futures symbols | Live chart cards can all show missing despite a wider intraday window having usable rows | Retry empty 1d / 1m symbols once with 2d / 1m and record fallback diagnostics. |
