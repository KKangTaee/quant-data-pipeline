...
- Heatmap must grow downward when many Trend Groups are selected. Keep a per-group row height rather than a capped height so sector labels and cell labels do not shrink into an unreadable grid.
