...
Status: 5차 Macro Risk Observation Complete / 6차 Calibration And Operational History Next
Last Updated: 2026-07-19

## Current Position

- 전체 roadmap: `5/6차 구현 완료`
- current milestone: 5차 Task 17 macro observation UI/Operations handoff complete; 6차 Task 18 history persistence next
...
1. Task 18 diagnosis snapshot / calibration artifact persistence
2. Task 19 historical replay / probability publication gate
3. Task 20 conditional probability/history UI
4. Task 21 regression, migration, Browser QA, durable docs closeout
...
- the storage migration, default-group creation, rollback, and mutating Browser QA remain Task 21 closeout work; no table was created automatically in 1~5차.
