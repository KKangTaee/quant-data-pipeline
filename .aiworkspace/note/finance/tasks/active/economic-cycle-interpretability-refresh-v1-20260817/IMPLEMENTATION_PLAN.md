...
- [ ] **Step 2: Run freshness tests and confirm RED**
...
- [ ] **Step 3: Implement official snapshot freshness**
...
- [ ] **Step 4: Write failing official refresh job tests**
...
- [ ] **Step 5: Run refresh job tests and confirm RED**
...
- [ ] **Step 6: Implement the RTDSM official refresh path**
...
- [ ] **Step 1: Write failing RTDSM quality tests**
...
- [ ] **Step 3: Implement cadence-aware quality metadata**
...
- [ ] **Step 6: Implement read-model separation**
...
- [ ] **Step 3: Implement current diagnosis and quality strip**
...
- [ ] **Step 4: Implement the approved Cycle route**
...
- [ ] **Step 5: Implement transition and evidence hierarchy**
...
- [ ] **Step 6: Implement ribbon and disclosure consistency**
...
- [ ] **Step 7: Fix the React refresh state regression test**
...
- [ ] **Step 8: Run React tests, typecheck, build, and commit**
...
- [ ] **Step 3: Implement presentation-only deduplication**
...
- [ ] **Step 4: Write failing signed metric tests**
...
- [ ] **Step 5: Implement signed period cells and legend**
...
- [ ] **Step 6: Run asset/React tests, build, and commit**
...
- [ ] **Step 3: Perform Browser QA on the real Streamlit page**
