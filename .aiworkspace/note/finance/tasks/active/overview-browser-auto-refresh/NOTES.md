...
- Loading UX stays local to the Market Movers `Data Refresh` panel; full-screen blocking was intentionally avoided so users can keep reading tables during the 5-second S&P 500 snapshot refresh.
