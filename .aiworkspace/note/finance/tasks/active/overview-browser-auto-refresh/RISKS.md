...
- Streamlit fragment execution can briefly block the visible session when the collector runs, though the blocking is now local to the Market Movers `데이터 갱신` surface.
