...
- V16 applies the same pattern to Sentiment. After this step, the active primary tab files are thin orchestration entrypoints and the tab-specific Streamlit glue lives in matching helper modules.
