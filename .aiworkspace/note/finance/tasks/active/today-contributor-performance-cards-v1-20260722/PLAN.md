...
2. **Python 성과 계약 (`2/4차`, 완료)**: item lane return과 Today projection을 TDD로 확장.
3. **React 카드 구현 (`3/4차`, 완료)**: compact contributor cards와 empty/partial state 구현.
...
종료 조건은 2026-07-22 fresh Python/React regression과 root `/`의 1280/760/420 actual Browser QA로 충족했다.
