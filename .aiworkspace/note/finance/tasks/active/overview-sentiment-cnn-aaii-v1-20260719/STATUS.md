...
- 검증: focused sentiment service/frontend unittest `24 passed`, React production build, `git diff --check`, actual desktop/420px Browser QA, AAII click/keyboard 전환, 좌우 끝 tooltip 경계, 실제 관측 hover, page/component 가로 overflow 0, fresh-tab console error 0을 확인했다.
