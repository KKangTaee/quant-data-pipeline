...
- [x] **Step 1: Write failing wrapper, loader, and fragment-scope tests**
...
- [x] **Step 2: Write failing one-shot phase transition tests**
...
- [x] **Step 3: Run all new tests and confirm RED**
...
- [x] **Step 4: Implement wrapper and island state**
...
- [x] **Step 5: Replace whole-page fragment with conditional island**
...
- [x] **Step 6: Implement phase transition helper and allowlist**
...
- [x] **Step 7: Run full regressions, rebuild, and commit Task 2**
...
- [x] **Step 2: Run actual CLOSED Browser QA**
...
- [x] **Step 3: Run controlled OPEN/island QA**
...
- [x] **Step 4: Synchronize docs and commit**
...
- [x] **Step 5: Apply verification-before-completion**
