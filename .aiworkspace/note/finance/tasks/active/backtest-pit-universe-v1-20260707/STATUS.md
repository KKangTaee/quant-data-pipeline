...
- Started after user approved monthly market-cap PIT snapshot direction.
- Working in `codex/backtest-dev`.
- Roadmap: 1차 schema/loader, 2차 builder, 3차 runner, 4차 UI/Data Trust, 5차 docs/QA.
- 1차 complete: added PIT universe schema contract, pure snapshot payload builder, and loader facade for included member snapshots.
- 2차 complete: added monthly PIT payload generation, idempotent snapshot/member upsert, and DB-source orchestration for prebuilt universe snapshots.
