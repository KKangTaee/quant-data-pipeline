...
- UI 방향: 기본 6M 유지, `6M / 1Y / 전체`가 CNN·AAII의 늦은 시작일을 공통 시작점으로 사용하고 x축 종료는 두 source 중 최신 날짜까지 확장한다. 각 선은 자기 source의 마지막 관측일에서 끝나며 보간하지 않는다. CNN 끝점은 marker만 남기고 중복 수치 text는 header·hover로만 제공한다.
