...
문서 구조가 `.aiworkspace/note/finance/docs/`, `tasks/active/`, `phases/active/`, `reports/backtests/` 중심으로 바뀌었지만 기존 finance skill 일부는 여전히 legacy root 문서와 `phase<N>` 구조를 참조하고 있었다.
