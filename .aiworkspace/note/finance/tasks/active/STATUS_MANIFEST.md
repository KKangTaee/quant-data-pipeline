...
- `etf-evidence-expansion-20260608`: 3D ETF Evidence Expansion. Read-only current anchor / near miss / not-ready reason / required evidence / next workflow panel for GRS / Risk Parity / Dual Momentum.
